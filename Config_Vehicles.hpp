    ...
    */
    class civ_car {
        ...
        vehicles[] = {
            ...
            { "C_Hatchback_01_F", 25000, { "driver" }, { "", "", -1 } },
            { "C_Offroad_01_F", 35000, { "driver" }, { "", "", -1 } },
            { "C_SUV_01_F", 65000, { "driver" }, { "", "", -1 } },
            { "C_Van_01_transport_F", 85000, { "driver" }, { "", "", -1 } }
        };
    };
    ...
    class med_air_hs {
        side = "med";
        vehicles[] = {
            { "B_Heli_Light_01_F", 325000, { "mAir" }, { "", "", -1 } },
            { "O_Heli_Light_02_unarmed_F", 500000, { "mAir" }, { "", "", -1 } }
        };
    };
    ...
    class civ_truck {
        ...
        vehicles[] = {
            ...
            { "I_Truck_02_transport_F", 266667, { "trucking" }, { "", "", -1 } },
            { "I_Truck_02_covered_F", 366667, { "trucking" }, { "", "", -1 } },
            { "B_Truck_01_transport_F", 666667, { "trucking" }, { "", "", -1 } },
            { "O_Truck_03_transport_F", 566667, { "trucking" }, { "", "", -1 } },
            { "O_Truck_03_covered_F", 1466667, { "trucking" }, { "", "", -1 } },
			{ "B_Truck_01_covered_F", 3333333, { "trucking" }, { "", "", -1 } },
            { "B_Truck_01_box_F", 6666667, { "trucking" }, { "", "", -1 } },
			{ "O_Truck_03_ammo_F", 11333333, { "trucking" }, { "", "", -1} },
            { "O_Truck_03_device_F", 13333333, { "trucking" }, { "", "", -1 } }
        };
    };
    ...
    class reb_car {
        side = "civ";
        vehicles[] = {
            { "B_Quadbike_01_F", 25000, { "rebel" }, { "", "", -1 } },
            { "B_G_Offroad_01_F", 50000, { "rebel" }, { "", "", -1 } },
            { "B_Heli_Light_01_F", 2500000, { "rebel" }, { "", "", -1 } },
            { "B_G_Offroad_01_armed_F", 15000000, { "rebel" }, { "", "", -1 } }
        };
    };
    ...
    class cop_car {
        side = "cop";
        vehicles[] = {
            { "C_Offroad_01_F", 20000, { "" }, { "life_coplevel", "SCALAR", 1 } },
            { "C_SUV_01_F", 40000, { "" }, { "life_coplevel", "SCALAR", 5 } },
            { "C_Hatchback_01_sport_F", 30000, { "" }, { "life_coplevel", "SCALAR", 6 } },
            { "B_MRAP_01_F", 30000, { "" }, { "life_coplevel", "SCALAR", 8 } }
        };
    };
    ...
    class civ_air {
        side = "civ";
        vehicles[] = {
            { "B_Heli_Light_01_F", 1333333, { "pilot" }, { "", "", -1 } },
            { "O_Heli_Light_02_unarmed_F", 3000000, { "pilot" }, { "", "", -1 } },
			{ "I_Heli_Transport_02_F", 7333333, { "pilot" }, { "", "", -1 } }
        };
    };
    ...
    class cop_air {
        side = "cop";
        vehicles[] = {
            { "B_Heli_Light_01_F", 500000, { "cAir" }, { "life_coplevel", "SCALAR", 5 } },
            { "B_Heli_Transport_01_F", 750000, { "cAir" }, { "life_coplevel", "SCALAR", 5 } },
			{ "B_Heli_Transport_03_unarmed_F", 2500000, { "cAir" }, { "life_coplevel", "SCALAR", 7} }
        };
    };
    ...
    class cop_ship {
        side = "cop";
        vehicles[] = {
            { "B_Boat_Transport_01_F", 15000, { "cg" }, { "life_coplevel", "SCALAR", 4 } },
            { "C_Boat_Civil_01_police_F", 15000, { "cg" }, { "life_coplevel", "SCALAR", 4 } },
            { "B_Boat_Armed_01_minigun_F", 7500000, { "cg" }, { "life_coplevel", "SCALAR", 9 } },
            { "B_SDV_01_F", 1000000, { "cg" }, { "life_coplevel", "SCALAR", 4 } }
        };
    };
    ...
    class civ_ship {
        side = "civ";
        vehicles[] = {
            { "C_Rubberboat", 7500, { "boat" }, { "", "", -1 } },
            { "C_Boat_Civil_01_F", 17500, { "boat" }, { "", "", -1 } },
            { "B_SDV_01_F", 2000000, { "boat" }, { "", "", -1 } }
        };
    };
};
...
/*			{ "Polizei", "cop", {
*				"textures\PolizeHunter",
*				"textures\PolizeiHunter3"
*			} }
*/        };
    };
	...
	class B_Heli_Transport_03_unarmed_F {
		vItemSpace = 650;
        storageFee[] = { 200000, 200000, 200000, 200000 };
